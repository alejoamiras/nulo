...
- **Storage version bumps are destructive.** No production users → wipe-on-bump is the migration model. See [`../../ARCHITECTURE.md`](../../ARCHITECTURE.md) §5 and `src/wallet/storage/migrate.ts`.
