 ...
 */
// TODO(network-playground): discovery queue drain timing is brittle in the test (90s timeout); needs a deterministic 'queued' signal from the extension before unlock
test.skip("connect-locked-queue — discovery queued while locked, drained on unlock", { timeout: 90_000 }, async ({
