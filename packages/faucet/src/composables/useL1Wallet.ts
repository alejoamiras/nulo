 ...
 * `@nulo/bridge-core` only at the PRIMITIVE boundary (addresses / amounts / a request fn),
 * never by sharing viem `WalletClient` / `Chain` types across the canonical↔fork line.
 */
