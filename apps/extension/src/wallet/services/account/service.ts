...
import { ACCOUNT_SERVICE_NAME, ACCOUNT_STORAGE_ROOT, AccountType, type Account, type Events, type Methods } from "./spec"
...
export class AccountService extends Service<Methods, Events> implements ServiceSpec<Methods, Events> {
	...
	public constructor(logger: ILogger, browserApi: BrowserApi) {
		...
		this.storage = new EntityStorage<Account>(ACCOUNT_STORAGE_ROOT, browserApi.storage.local)
	}
