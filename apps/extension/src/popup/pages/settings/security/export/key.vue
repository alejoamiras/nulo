...
// the seed page — the block was previously duplicated word for word here).
const { isCopied, copySecret } = useSecretClipboardCopy({ toastLabel: "Key is copied", openToast })
const handleCopy = (key) => {
	copySecret(key === "private" ? privateKey.value : publicKey.value)
}
