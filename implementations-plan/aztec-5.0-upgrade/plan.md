...
**Infra fixes (5.0 sandbox boot — required before any shard runs; root-cause writeup in `lessons/phase-6.md`).** Three blockers surfaced in CI, all systematic (every shard `exit 86`, not flaky):
