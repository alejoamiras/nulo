...
- [private-fuel](private-fuel/plan.md) — in progress (deep), approved; P0 ✓ (keystone: DOM_SEP=3952304070 + FPC `0x1b1706cc…` pinned, tripwire + 104/104 green). BLOCKER: testnet nodeVersion 4.3.1 vs our 4.2.0 pin (Ask 1 — blocks P4 fund-moving, canary-or-rebump decision) — private Fee Juice via Wonderland PrivateFPC; gas-follows-token, B-presets, fee-method matrix
