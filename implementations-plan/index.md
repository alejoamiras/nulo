...
- [e2e-proverless-stub](e2e-proverless-stub/plan.md) — all phases ✓, PR #86 open to dev (deep; 3 plans + audit round + post-impl codex audit) — proverEnabled:false for bulk network e2e + SW-side barrier-gated stub for sequencing/cancel + prover-ON canaries; double-opt-in + DCE + negative-grep prod guard
