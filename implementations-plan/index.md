...
- [bridge-form-stepper](bridge-form-stepper/plan.md) — approved (mid), in implementation — guided form flow (stepper + receipt), active-flow card suppression, wallet chips row, Pending Bridges rename
