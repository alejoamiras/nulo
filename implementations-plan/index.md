...
- [bridge-form-stepper](bridge-form-stepper/plan.md) — implemented (mid), awaiting manual testnet validation — guided form flow (stepper + receipt), active-flow card suppression, wallet chips row, Pending Bridges rename
