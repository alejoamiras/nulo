...
- [e2e-proverless-stub](e2e-proverless-stub/plan.md) — APPROVED (deep; 3 plans + 2-channel audit + final codex APPROVE), Phase 0 in progress — proverEnabled:false for bulk network e2e + controllable barrier-gated stub for sequencing/cancel; source-level double-opt-in prod guard
