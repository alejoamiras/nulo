...
*(gate green 2026-08-13: typecheck:all + test (4032) + design test (295) + lint exit 0 — see lessons/phase-1.md; threshold measured → 15 blocks, single constant)*
...
*(gate green 2026-08-13: typecheck:all + test (4036) + design test (299, incl. Tooltip focus) + lint 0 errors — see lessons/phase-2.md)*
