...
#### Phase 2 — Proof in real builds and real CI ✓ (2026-09-01, dispatch run 33565490934 success, armed smoke 31/31, gate in lessons/phase-2.md)
...
#### Phase 3 — Docs + arc-1 allow-list ✓ (2026-09-01, allow-list + gate in lessons/phase-3.md)
