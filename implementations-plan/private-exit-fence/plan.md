...
| 2 | Exit gas limits | Reuse the claim's measured limits as the ceiling (an upper bound for a lighter transaction); a measured `PRIVATE_HUB_EXIT_GAS` is a canary follow-up. **Done in phase 2 (2026-09-06):** the sandbox smoke's FPC-paid private exits, as a Nulo-derivation Schnorr account, billed 826,543 L2 / 1,696 DA over one credit note and 888,143 / 1,760 over three (≈30,800 L2 per further note); the constant is now `{ daGas: 50_000, l2Gas: 1_900_000 }` (2.3× the one-note bill, room for thirty-two notes beyond the three-note one; 28× DA), see `lessons/phase-2.md`. |
