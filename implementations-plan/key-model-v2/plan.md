...
### Phase 4 — product cuts + copy ✓ (code complete; audit:vue green 2026-08-18; smoke `test:e2e` pending harness — lessons/phase-4.md)
...
### Phase 5 — Export/Import Account ✓ (code complete; audit:vue green 2026-08-19; smoke + P6 network leg pending e2e:agent — lessons/phase-5.md)
