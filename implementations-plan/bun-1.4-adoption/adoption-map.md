...
## Arc D — `/blueprint light` — `bun-native-tooling` (after C; bridge-core parts anytime) — **IMPLEMENTED as Node-API hardening** ([bun-native-tooling/plan.md](https://github.com/alejoamiras/nulo/blob/6611f8611100931fe266f6fd1dfff27e331e2897/implementations-plan/bun-native-tooling/plan.md))
