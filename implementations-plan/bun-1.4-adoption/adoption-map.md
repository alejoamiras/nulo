...
## Arc D — `/blueprint light` — `bun-native-tooling` (after C; bridge-core parts anytime) — **IMPLEMENTED as Node-API hardening** ([bun-native-tooling/plan.md](https://github.com/alejoamiras/nulo/blob/<FREEZE_SHA>/implementations-plan/bun-native-tooling/plan.md))
