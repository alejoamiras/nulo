...
- **End-diff validation:** popup+window suites 154/154; design package 313/313; audit:vue green; armed smoke green; SOLO `senders-advanced` network spec green. Final-tree smoke re-run + codex convergence resume recorded below.
