...
### Phase 4 ✓ — review loop, then the PR (2026-09-22; codex r4 + r5 converged, `lessons/phase-4.md`; PR #669 into `dev`, labelled after creation; the four status checks are the gate, verified on the PR)
